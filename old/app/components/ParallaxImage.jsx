// This is copied from https://github.com/TylerK/react-parallax-hover/blob/master/src/parallax-hover.js
...
export default class ParallaxImage extends React.Component {
    ...
    __renderChildren(children) {
        ...
        return children.map((layer, key) => {
            ...
            if (layer.ref === 'text') {
                ...
                layer = layer.props.children; /* eslint no-param-reassign:0 */
    ...
    render() {
        ...
        return (
            <div style={styles.phOutter()} onClick={this.props.onClick}>
                <figure
                    ref="wrapper" className="ph-wrapper" style={stylesWrapper}
                    onMouseMove={this.__handleMouseMove.bind(this)}
                    onMouseLeave={this.__handleMouseLeave.bind(this)}>
